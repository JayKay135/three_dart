...
//           canvas.drawCircle(
//             Offset(background.left + radiusBackground, background.top + radiusBackground),
//             radiusBackground,
//             paintBg,
//           );
//         });
...
//     if (_screenSize != null && (position.dx > _screenSize!.x / 3 || position.dy < _screenSize!.y / 3 || isFixed)) return;
